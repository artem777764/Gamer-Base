    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavouriteGames", x => new { x.UserId, x.GameId });
                    table.ForeignKey(
                        name: "FK_FavouriteGames_Games_GameId",
                        column: x => x.GameId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_EntityTypes_EntityTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VotesReview", x => new { x.UserId, x.ReviewId });
                    table.ForeignKey(
                        name: "FK_VotesReview_Reviews_ReviewId",
                        column: x => x.ReviewId,
                        principalTable: "Reviews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VotesReview_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VotesComment", x => new { x.UserId, x.CommentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_EntityTypeId",
                table: "Notifications",
                column: "EntityTypeId");
